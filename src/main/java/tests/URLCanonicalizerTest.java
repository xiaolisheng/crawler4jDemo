...
public class URLCanonicalizerTest {
	...
	public void testCanonizalier() {
		...
		assertEquals("http://www.example.com/?q=a%2Bb", URLCanonicalizer
		...
		assertEquals("http://www.example.com/index.html", URLCanonicalizer
		...
		assertEquals("http://www.example.com/bar.html", URLCanonicalizer
		...
		assertEquals("http://www.example.com/~username/", URLCanonicalizer
				.getCanonicalURL("http://www.example.com/%7Eusername/"));

		assertEquals("http://www.example.com/A/B/index.html", URLCanonicalizer
				.getCanonicalURL("http://www.example.com//A//B/index.html"));

		assertEquals("http://www.example.com/index.html?x=y", URLCanonicalizer
				.getCanonicalURL("http://www.example.com/index.html?&x=y"));

		assertEquals("http://www.example.com/a.html", URLCanonicalizer
		...
		assertEquals("http://foo.bar/mydir/myfile?page=2", URLCanonicalizer
				.getCanonicalURL("?page=2", "http://foo.bar/mydir/myfile"));
